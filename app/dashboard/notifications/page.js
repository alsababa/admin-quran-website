        ...
        <div className="space-y-10 pb-20 text-right" dir="rtl">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-8">
                <div>
                    <h3 className="text-4xl font-black text-white tracking-tighter flex items-center gap-4">
                        الإشعارات الجماعية
                        <Sparkles className="text-[#14B8A6] animate-pulse" size={32} />
                    </h3>
                    <p className="text-[#14B8A6]/40 font-bold text-sm mt-2">أرسل تنبيهات مباشرة لجميع مستخدمي التطبيق (FCM Broadcast).</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <div className="xl:col-span-2 space-y-6">
                    <div className="glass-panel rounded-[2.5rem] p-10 relative overflow-hidden border-[#14B8A6]/10 shadow-2xl">
                        ...
                        <div className="flex items-center gap-4 mb-8">
                            ...
                            <div>
                                ...
                                <p className="text-[#14B8A6]/40 text-xs font-bold mt-0.5">املاً البيانات لإرسال التنبيه فوراً</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-black uppercase tracking-widest text-[#14B8A6]/50 mr-2">عنوان الإشعار</label>
                                <input
                                    type="text"
                                    placeholder="مثال: تحديث جديد متاح، أو تهنئة بالعيد..."
                                    className="w-full h-14 glass-input rounded-2xl px-6 text-sm font-bold text-white focus:border-[#14B8A6]/40 transition-all"
                                    value={title}
                            ...
                            {/* Body */}
                            <div className="space-y-2">
                                <label className="text-[10px] font-black uppercase tracking-widest text-[#14B8A6]/50 mr-2">نص الإشعار (Body)</label>
                                <textarea
                                    placeholder="اكتب تفاصيل الإشعار هنا..."
                                    className="w-full min-h-[120px] glass-input rounded-3xl px-6 py-5 text-sm font-medium text-white focus:border-[#14B8A6]/40 transition-all resize-none"
                                    value={body}
                            ...
                            <div className="space-y-4">
                                <label className="text-[10px] font-black uppercase tracking-widest text-[#14B8A6]/50 mr-2">نوع الإشعار والتوجيه</label>
                                    ...
                                    {[
                                        ...
                                        <button
                                            ...
                                            className={`h-14 rounded-2xl border transition-all flex items-center justify-center gap-2 text-xs font-black
                                                ${type === t.id 
                                                    ? 'bg-[#14B8A6]/10 border-[#14B8A6]/30 text-[#14B8A6] shadow-lg shadow-[#14B8A6]/5' 
                            ...
                            <AnimatePresence>
                                {type === 'sign_language' && (
                                    ...
                                    >
                                        <div className="p-6 bg-[#14B8A6]/5 border border-[#14B8A6]/10 rounded-3xl grid grid-cols-2 gap-6">
                                            <div className="space-y-2">
                                                <label className="text-[9px] font-black uppercase text-[#14B8A6]/60 flex items-center gap-2">
                                            ...
                                            <div className="col-span-2 text-[10px] text-[#14B8A6]/40 font-bold border-t border-[#14B8A6]/10 pt-4 flex items-center gap-2">
                            ...
                            <div className="pt-6">
                                <button
                                    ...
                                    className="w-full h-16 bg-[#14B8A6] text-[#0A0D1A] font-black rounded-[1.25rem] hover:bg-[#0D9488] transition-all active:scale-95 disabled:opacity-30 flex items-center justify-center gap-3 text-lg shadow-xl shadow-[#14B8A6]/20"
                                >
                                    {isSending ? <Loader2 size={24} className="animate-spin" /> : <Send size={24} />}
                                    إرسال الإشعار لجميع الأجهزة
                                </button>
                                <p className="text-center text-[10px] font-bold text-[#14B8A6]/30 mt-4 uppercase tracking-[0.2em]">
                ...
                <div className="space-y-8">
                    ...
                    <div className="glass-panel rounded-[2.5rem] p-8 border-white/5 relative overflow-hidden flex flex-col items-center">
                        <div className="text-[10px] font-black uppercase tracking-widest text-[#14B8A6]/40 mb-6 flex items-center gap-2">
                        ...
                        <div className="w-full max-w-[260px] aspect-[9/19] bg-[#1a1c2e] border-4 border-[#2a2d4a] rounded-[2.5rem] p-4 relative shadow-2xl">
                            ...
                            >
                                <div className="flex items-center gap-2 mb-2">
                                    <div className="w-5 h-5 bg-[#14B8A6] rounded-md flex items-center justify-center">
                        ...
                        <div className="mt-8 flex items-center gap-2 text-[#14B8A6]/40 text-[10px] font-bold">
                            <Smartphone size={12} /> يظهر الإشعار تلقائياً على شاشة القفل والمنبثقة
                        </div>
                    </div>

                    {/* Quick Tips */}
                    <div className="glass-panel rounded-3xl p-8 border-[#14B8A6]/5 space-y-4">
                    ...
                    <div className="fixed inset-0 z-[150] flex items-center justify-center p-6">
                        ...
                        >
                            ...
                            <div className="flex gap-4">
                                ...
                                <button
                                    onClick={handleSend}
                                    className="flex-1 h-14 bg-[#14B8A6] text-[#0A0D1A] font-black rounded-2xl hover:bg-[#0D9488] transition-all"
                                >
                                    تأكيد وإرسال
                                </button>
                            </div>
