...
if len(bytes_content) > 33642:
    context = bytes_content[33642-50:33642+50]
    print(f"BYTES AROUND 33642: {context}")
    print(f"TEXT AROUND 33642: {context.decode('utf-8', errors='replace')}")
    
    # Find line number
    before = bytes_content[:33642]
